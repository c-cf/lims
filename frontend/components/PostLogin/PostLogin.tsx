    ...
    ? [
        {
          ...
          cn: '儀表板',
          status: 'created',
          note: 'Welcome glance + open requests',
        },
        {
          label: 'My Requests',
          cn: '我的申請',
          status: 'created',
          note: 'Filterable list, status pipeline',
        },
        {
          label: 'Drafts',
          cn: '草稿',
          status: 'pending',
          note: 'Saved-but-unsubmitted commissions',
        },
        {
          label: 'New Request',
          cn: '新申請',
          status: 'pending',
          note: 'Multi-section form, sample table',
        },
        {
          label: 'Request detail · #',
          cn: '申請詳情',
          status: 'pending',
          note: 'Approval history + run progress',
        },
      ]
    : [
        {
          ...
          cn: '儀表板',
          status: 'created',
          note: "Today's queue + activity feed",
        },
        {
          label: 'Samples',
          cn: '樣品',
          status: 'created',
          note: 'Receive / reject incoming wafers',
        },
    ...
    <div className="app">
      ...
      <main className="main">
        <TopBar
          ...
          right={
            isFab ? (
              <Button variant="dark" icon={<I.Plus />}>
                New Request
              </Button>
            ) : (
              <>
                <Button variant="secondary" icon={<I.Inbox />}>
                  Bulk receive
                </Button>
                <Button variant="dark" icon={<I.Plus />}>
                  Receive samples
        ...
        <div
          style={{ padding: '24px 32px 48px', display: 'flex', flexDirection: 'column', gap: 20 }}
        >
          {}
          <div
            style={{
              ...
              borderRadius: 12,
              background:
                'linear-gradient(135deg, rgba(244,168,191,0.08) 0%, rgba(187,183,232,0.08) 100%)',
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              >
                Login + role-aware shell are wired up. You&apos;re signed in as{' '}
                <code
                  style={{
                    background: '#ebebf0',
                    padding: '1px 6px',
                ...
                ({user.subtitle}). Sidebar nav, top bar, and design tokens are live — the role split
                routes you to the right surface on sign-in.
              </div>
            </div>
              ...
              <div>
                {foundation.map((p, i) => (
                  ...
                  >
                    ...
                    <Badge
                      status={p.status}
                      label={p.status === 'created' ? 'Scaffolded' : 'Not built'}
                    />
                  </div>
                ))}
              </div>
            ...
            <Card>
              ...
              <div style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  ...
                  <KV
                    label="Default route"
                    value={<IDChip id={navItems[0].id} prefix="/" size="sm" />}
                  />
                  <KV
                    label="Date"
                    value={
          ...
          <Card>
            <div style={{ padding: '16px 20px', borderBottom: '1px solid var(--border)' }}>
              ...
              <div style={{ marginTop: 6, fontSize: 13.5, color: 'var(--text-secondary)' }}>
                ...
                . Every page below this foundation uses the same tokens.
              </div>
            </div>
            <div
              style={{
