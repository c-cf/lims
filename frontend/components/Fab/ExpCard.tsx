  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <span style={{ fontSize: 14.5, color: 'var(--text-primary)', fontWeight: 700, flex: 1 }}>
          {exp.name}
        </span>
        <span
          style={{
        ...
        >
          {active && <F.Check size={10} color="#fff" strokeWidth={3} />}
        </span>
      </div>
      {exp.desc && (
        <div
          style={{ fontSize: 12.5, color: 'var(--text-secondary)', marginTop: 8, lineHeight: 1.5 }}
        >
          {exp.desc}
        </div>
      )}
