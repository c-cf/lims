...
const LoginPage = ({ onLogin }: { onLogin: (user: LoginUser) => void }) => {
  ...
  const submit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (api && api.auth) {
      setBusy(true);
      try {
        const user = await api.auth.login(u, password);
        onLogin({
    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: '#fff' }}>
      ...
      >
        ...
        <div
          style={{
            ...
            height: 380,
            borderRadius: '50%',
            background: 'radial-gradient(circle, rgba(108,103,184,0.32) 0%, transparent 65%)',
            filter: 'blur(40px)',
          }}
        />
        <div
          style={{
            ...
            height: 320,
            borderRadius: '50%',
            background: 'radial-gradient(circle, rgba(244,168,191,0.20) 0%, transparent 65%)',
            filter: 'blur(40px)',
          }}
        />
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          >
            End-to-end lab operations — commission requests, sample tracking, experiment dispatch,
            and reporting in one unified platform.
          </p>
        </div>
        ...
        <div style={{ display: 'flex', gap: 56, position: 'relative', zIndex: 1 }}>
          {[
            ...
            <div key={s.l}>
              ...
              <div style={{ fontSize: 13, color: 'rgba(226,232,240,0.55)', marginTop: 4 }}>
                {s.l}
              </div>
            </div>
          ))}
      ...
      >
        <form onSubmit={submit} style={{ width: '100%', maxWidth: 400 }}>
          <h2 style={{ fontSize: 32, fontWeight: 700, letterSpacing: '-0.02em', color: '#0f172a' }}>
            Sign in
          </h2>
          ...
          <div style={{ marginTop: 32 }}>
            ...
            <input
              ...
              onBlur={(e) => {
                ...
                e.target.style.background = '#eef2f9';
              }}
          ...
          <button
            ...
            onMouseEnter={(e) => {
              if (!busy) e.currentTarget.style.filter = 'brightness(0.92)';
            }}
              ...
              {Object.entries(ACCOUNTS).map(([u, a]) => (
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div
                      style={{ fontSize: 13, fontWeight: 600, color: '#0f172a', lineHeight: 1.3 }}
                    >
                      {u}
                    </div>
                    <div style={{ fontSize: 11, color: '#94a3b8' }}>
                      {a.subtitle} · click to fill
                    </div>
                  </div>
