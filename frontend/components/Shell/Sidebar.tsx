  ...
  return (
    <aside
      style={{
        ...
        left: 0,
        top: 0,
        background: isFab ? '#0f172a' : 'var(--bg-sidebar)',
        color: '#cbd5e1',
        display: 'flex',
    ...
    >
        ...
        <>
          ...
          <div
            style={{
              ...
              background: '#f4a8bf',
              borderRadius: '50%',
              animation: 'lims-twinkle 3.2s infinite',
            }}
          />
          <div
            style={{
              ...
              background: '#bbb7e8',
              borderRadius: '50%',
              animation: 'lims-twinkle 4.1s infinite 0.8s',
            }}
          />
          <div
            style={{
              ...
              background: '#9ebbc8',
              borderRadius: '50%',
              animation: 'lims-twinkle 3.6s infinite 1.6s',
            }}
          />
        </>
      )}
        ...
        <div
          style={{
            ...
            boxShadow: isFab
              ...
              : '0 2px 10px rgba(244,168,191,0.35)',
          }}
        >
      ...
      <div
        style={{
          ...
          padding: isFab ? '16px 18px' : '14px 14px',
          display: 'flex',
          alignItems: 'center',
          gap: 11,
          position: 'relative',
      ...
      >
        <div
          style={{
            ...
            height: isFab ? 36 : 34,
            borderRadius: '50%',
            background: isFab ? '#2563eb' : 'linear-gradient(135deg, #f4a8bf 0%, #bbb7e8 100%)',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
            color: '#fff',
        ...
        {onLogout && (
          <button
            ...
            onMouseLeave={(e) => {
              e.currentTarget.style.background = 'transparent';
              e.currentTarget.style.color = isFab ? '#64748b' : '#888899';
            }}
          >
            {isFab ? <I.ChevronDown size={14} /> : <I.LogOut size={14} />}
          </button>
        )}
      </div>
    </aside>
