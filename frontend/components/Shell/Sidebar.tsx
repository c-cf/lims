...
const Sidebar=({route,navigate,counts={},user,onLogout,navItems=NAV_ITEMS,navSections=null,sectionLabel='Lab Operations',sublabel:_sublabel='Lab Operator'})=>{const isFab=false;const sections=navSections||[{label:sectionLabel,items:navItems}];return<aside style={{width:'var(--sidebar-width)',height:'100vh',position:'fixed',left:0,top:0,background:isFab?'#0f172a':'var(--bg-sidebar)',color:'#cbd5e1',display:'flex',flexDirection:'column',borderRight:'1px solid rgba(255,255,255,0.04)',zIndex:20,overflow:'hidden'}}>
    {!isFab&&<>
      {}
