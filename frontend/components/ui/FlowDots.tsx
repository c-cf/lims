...
const FlowDots=({steps,current,size=6,gap=4,doneColor='var(--primary)',currentColor='var(--primary)',style=undefined})=>{const idx=steps.indexOf(current);return<span style={{display:'inline-flex',alignItems:'center',gap,...style}}>
