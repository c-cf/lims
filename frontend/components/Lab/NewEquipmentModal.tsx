...
const NewEquipmentModal = ({
  ...
  const [paramRows, setParamRows] = React.useState([{ key: '', value: '' }]);
  React.useEffect(() => {
    if (!open) return;
    setName('');
    setType(EXPERIMENTS[0].code);
    setDescription('');
    setCapacity('1');
    ...
    <Modal
      ...
      footer={
        <>
          ...
          <PrimaryBtn disabled={!valid} onClick={handle}>
            Create Equipment
          </PrimaryBtn>
        </>
      }
        ...
        <div>
          ...
          >
            ...
            <span style={{ fontSize: 11.5, color: muted }}>
              Defaults that operators can override per dispatch.
            </span>
          </div>
          <div
            style={{
