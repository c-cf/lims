...
const LabEquipment = ({ navigate: _navigate, canManage = false, showToast }) => {
  ...
  return (
    <Page
      ...
      right={
        canManage && (
          <PrimaryBtn icon={<LF.Plus size={14} />} onClick={openNew}>
            Add Equipment
          </PrimaryBtn>
        )
      }
    >
      ...
      <div style={{ fontSize: 13, color: muted, marginBottom: 14 }}>
        Showing <strong style={{ color: ink }}>{filtered.length}</strong> of {equipment.length} unit
              ...
              <Card key={e.id} padding={0}>
                ...
                <div style={{ padding: 20 }}>
                  ...
                  >
                    ...
                    <span style={{ fontFamily: 'var(--font-mono)', fontWeight: 700, color: ink }}>
                      {e.capacity}
                    </span>
                  </div>
                  <div
                  ...
                  >
                    <div
                      style={{ width: '0%', height: '100%', background: accent, borderRadius: 999 }}
                    />
                  </div>
