    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: 999,
          background:
            'radial-gradient(circle at center, rgba(244,168,191,0.35), rgba(244,168,191,0) 65%)',
          pointerEvents: 'none',
          filter: 'blur(8px)',
        }}
      />
      <div
        style={{
          ...
          borderRadius: 999,
          background:
            'radial-gradient(circle at center, rgba(108,103,184,0.45), rgba(108,103,184,0) 65%)',
          pointerEvents: 'none',
          filter: 'blur(8px)',
        }}
      />
      ...
      >
        <div>
          ...
          >
            {counts.running > 0 ? (
              <>
                {counts.running} experiment{counts.running === 1 ? '' : 's'} running.{' '}
                {counts.needsRecord > 0
                  ? `${counts.needsRecord} awaiting your result.`
                  : 'No results pending.'}
              </>
            ) : counts.incoming > 0 ? (
              <>
