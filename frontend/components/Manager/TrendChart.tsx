...
const TrendChart = () => {
  ...
  if (loading && !trend) {
    return (
      <Card
        padding={22}
        style={{ marginTop: 18, textAlign: 'center', color: mMuted, fontSize: 13 }}
      >
        Loading trend…
      </Card>
    );
      ...
      >
        <span
          style={{
            ...
            borderRadius: 999,
            background: '#6c67b8',
            boxShadow: '0 0 10px rgba(108,103,184,0.45)',
          }}
        />
        <div>
          <div style={{ fontSize: 15, fontWeight: 700, color: mInk, letterSpacing: '-0.01em' }}>
            資源利用 / 產能趨勢
          </div>
