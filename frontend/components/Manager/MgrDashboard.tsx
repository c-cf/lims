  ...
  return (
    <Page title="Dashboard" subtitle="Welcome back, lab_manager">
      ...
      >
        <MgrStatTile
          label="To approve"
          value={v(pending.length)}
          icon={<MI.Clock size={16} />}
          tint="#fef0d4"
          accent="#b8720e"
        ...
        {pending.length === 0 ? (
          ...
          pending.map((r) => (
            <button
              ...
              style={{
                display: 'grid',
                gridTemplateColumns: '90px 1fr 110px 130px auto',
                alignItems: 'center',
                gap: 14,
                width: '100%',
                padding: '14px 22px',
                borderTop: `1px solid ${mLineSft}`,
                background: '#fff',
                border: 'none',
                cursor: 'pointer',
                textAlign: 'left',
            ...
            >
              ...
              <div style={{ minWidth: 0 }}>
                ...
                >
                  ...
                  <span>
                    {r.sampleCount ?? r.samples.length} wafer
